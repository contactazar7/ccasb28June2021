        ...
        action.setCallback(this,function(response){
            if(response.getState() === "SUCCESS"){
                ...
                var cols = [
                    ...
                    {label: 'Edfund Faciltiy', fieldName: 'Edfund_Facility__c', type: 'text'},
                    {label: "Total Hours (Classroom/Theory)", fieldName: "Total_Hours_Classroom_Theory__c",   type: 'formula'}, 
                    {label: "Total Hours (Clinical/Preceptor)", fieldName: "Total_Hours_Clinical_Preceptor__c",   type: 'formula'}, 
        ...
        action.setCallback(this,function(response){
            if(response.getState() === "SUCCESS"){
                ...
                allRecords.forEach(rec => {
                    ...
                    component.set("v.edfundVendor", rec.EdFundVendor_formula__c);
                });
