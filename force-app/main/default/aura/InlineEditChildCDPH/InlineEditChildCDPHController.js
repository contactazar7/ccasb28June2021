({
    ...
    doInit: function(component, event, helper) {
     helper.fetchPickListValyear(component, 'CDPH_Responding_to_Dementia_Behaviour__c', 'washPicklistOpts');
 helper.fetchPickListValburnout(component, 'CDPH_Home_Safety__c', 'AvoidingBurnoutvals');
  helper.fetchPickListValComDocForm(component, 'CDPH_Handwashing__c', 'CompleteDocumentationFormvals');
  helper.fetchPickListValDressUndress(component, 'CDPH_Medication_Safety__c', 'DressingUndressingvals');
  helper.fetchPickListValhelpmanage(component, 'CDPH_Urgent_Care_vs_Emergency_Care__c', 'managehallvals');
  helper.fetchPickListValhomsafe(component, 'CDPH_Model_of_Care__c', 'homsafvals');
