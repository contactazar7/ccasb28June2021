({
    setupTable : function(component, data){
        /**console.log('setupTable v.data'+JSON.parse(JSON.stringify(component.get("v.data"))));
        console.log('setupTable v.columns'+JSON.parse(JSON.stringify(component.get("v.columns"))));**/
        var cols = component.get("v.columns"),
            data = component.get("v.data");
        /**console.log(JSON.parse(JSON.stringify(component.get("v.data"))));
        console.log(JSON.parse(JSON.stringify(component.get("v.columns"))));**/
    ...
    setupData : function(component, data){        
        ...
        //console.log('Check setupData v.data before'+JSON.parse(JSON.stringify(component.get("v.dataCache"))));
        component.set("v.dataCache", JSON.parse(JSON.stringify(data)));
        //console.log('Check setupData v.data after'+JSON.parse(JSON.stringify(component.get("v.dataCache"))));        
        if(data){
            ...
            /**console.log('Check setupData v.data before'+JSON.parse(JSON.stringify(component.get("v.tableData")))); 
            console.log('Check setupData v.data before'+JSON.parse(JSON.stringify(component.get("v.tableDataOriginal")))); 
            console.log('Check setupData v.data before'+JSON.parse(JSON.stringify(component.get("v.updatedTableData")))); 
            **/
            ...
            /**
            console.log('Check setupData v.data after'+JSON.parse(JSON.stringify(component.get("v.tableData")))); 
            console.log('Check setupData v.data after'+JSON.parse(JSON.stringify(component.get("v.tableDataOriginal")))); 
            console.log('Check setupData v.data after'+JSON.parse(JSON.stringify(component.get("v.updatedTableData")))); 
            **/    
        }
    },
